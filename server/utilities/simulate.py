...
from environment.settings import TRAINING_CSV_FOLDER_PATH, FINGERPRINT_FOLDER_PATH
...
def simulate_sending_fp(config_num):
    config_fp_dir = os.path.join(FINGERPRINT_FOLDER_PATH, "infected-c{}".format(config_num))
