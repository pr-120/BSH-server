...
from v10.agent.model import ModelOptimizedQLearningIF
...
class AgentOptimizedQLearningIF(AbstractAgent):
    def __init__(self, representation=None):
        ...
        if isinstance(representation, AgentRepresentation):  # build from representation
            ...
            self.model = ModelOptimizedQLearningIF(learn_rate=self.learn_rate, num_configs=self.num_output)
            ...
            self.model = ModelOptimizedQLearningIF(learn_rate=self.learn_rate, num_configs=num_configs)
