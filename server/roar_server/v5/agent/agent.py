...
from v5.agent.model import ModelIdealADQLearning
...
class AgentIdealADQLearning(AbstractAgent):
    def __init__(self, representation=None):
        ...
        if isinstance(representation, AgentRepresentation):  # build from representation
            ...
            self.model = ModelIdealADQLearning(learn_rate=self.learn_rate, num_configs=self.num_output)
            ...
            self.model = ModelIdealADQLearning(learn_rate=self.learn_rate, num_configs=num_configs)
