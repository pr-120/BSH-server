...
class ControllerCorpusQLearning(AbstractController):
    def loop_episodes(self, agent):
        ...
        eps_iter = range(1, MAX_EPISODES_V4 + 1) if DEBUG_PRINTING else tqdm(range(1, MAX_EPISODES_V4 + 1))
        for episode in eps_iter:
            ...
            while not is_rw_done():
                ...
                if is_simulation() and sim_encryption_progress >= SIM_CORPUS_SIZE_V4:
        ...
        results_plots_file = plot_average_results(all_summed_rewards, all_avg_rewards, all_num_steps, MAX_EPISODES_V4,
                                                  description)
